...
CREATE EVENT `clear_expired_tokens` ON SCHEDULE EVERY 5 MINUTE STARTS '2022-03-30 14:25:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
delete os from oauth_sessions os
left join oauth_session_access_tokens osat on os.id = osat.session_id
