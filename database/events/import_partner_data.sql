...
CREATE EVENT `datateam`.`import_partner_data` ON SCHEDULE EVERY 1 HOUR STARTS '2023-07-024 11:00:00' ON COMPLETION PRESERVE ENABLE COMMENT 'Imports partner data.' DO BEGIN
